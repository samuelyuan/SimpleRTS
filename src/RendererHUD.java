...
public class RendererHUD {
     ...
     */
    public void renderHUD(IGraphics g, GameUnitManager unitManager, GameTime gameTimer) {
        updateHUDLabels(unitManager, gameTimer);
        renderHUDBackgrounds(g);
        hudRoot.render(g);
    }
    
    private void updateHUDLabels(GameUnitManager unitManager, GameTime gameTimer) {
