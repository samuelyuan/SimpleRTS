...
public class PathUnit 
{
	...
	public boolean getIsPathCreated() { return isPathCreated; }
	public void setIsPathCreated(boolean flag) { this.isPathCreated = flag; }
	public boolean getIsMoving() { return isMoving; }
	public ArrayList<MapNode> getPath() { return movePath; }
	public void startMoving() { this.isMoving = true; }
	...
	public Point recalculateDest(int map[][], Point playerMapDest)
	{
		...
		//Set one of the eight neighboring tiles surrounding the destination as another destination point
		...
		for (int i = 0; i < directions.length; i++)
		{
			...
			if (playerMapDest.y + dy < 0 || playerMapDest.x + dx < 0) continue;
		...
		{
			//System.out.println("player map dest: " + playerMapDest.x + ", " + playerMapDest.y);
	...
	public boolean isPathFound() { return movePath != null; }
