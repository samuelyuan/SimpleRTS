...
public class GameUnitManagerTest {
    ...
    public void testLoadPlayerUnits() {
        ...
        assertEquals(new Point(2 * GameMap.TILE_WIDTH, 3 * GameMap.TILE_HEIGHT), unitManager.getPlayerList().get(0).getCurrentPoint());
    ...
    public void testLoadEnemyUnits() {
        ...
        assertEquals(new Point(1 * GameMap.TILE_WIDTH, 1 * GameMap.TILE_HEIGHT), unitManager.getEnemyList().get(0).getCurrentPoint());
